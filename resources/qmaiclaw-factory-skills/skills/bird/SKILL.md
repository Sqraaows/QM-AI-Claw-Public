---
name: bird
description: X/Twitter CLI for reading, searching, and posting tweets via browser cookies or Sweetistics API.
...
- Always confirm before posting tweets/replies